...
class DatasetGenerator:
    ...
    def __init__(self, config: dict = None, seed: int = 42):
        ...
        # ENUMS - Tipos categóricos do sistema
        # ============================================================
        self.robot_types = [
            AgentRole.ASSEMBLY_ROBOT.value,
            AgentRole.TRANSPORT_ROBOT.value,
            AgentRole.INSPECTION_ROBOT.value,
            AgentRole.CAMERA_ROBOT.value,
            AgentRole.SAFETY_ROBOT.value,
        ]
        
        self.human_roles = [
            AgentRole.SUPERVISOR.value,
            AgentRole.OPERATOR.value,
            AgentRole.TECHNICIAN.value,
        ]
        ...
        self.actions = [
            ...
            ActionType.CALIBRATION.value,
            ActionType.DIAGNOSTIC.value,
        ]
        
        self.resource_types = [
            ResourceType.DATABASE.value,
            ResourceType.ACTUATOR.value,
            ResourceType.SENSOR.value,
            ResourceType.CAMERA.value,
            ResourceType.SAFETY_SYSTEM.value,
            ResourceType.ADMIN_PANEL.value,
        ]
        
        # YAML - Específicos do domínio ICS
        # ============================================================
        self.resources = dataset_config.get('resources', [
        ...
        self.locations = dataset_config.get('locations', [
            'assembly_line', 'maintenance_bay', 'warehouse',
            'inspection_area', 'control_room'
        ])
